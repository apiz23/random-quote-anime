...
export default function App() {
	...
	return (
		<>
			<section className="min-h-screen w-full bg-slate-700 flex items-center justify-center">
				<div className="mx-auto">
					...
					<div className="my-10 mx-5 md:my-15 md:max-w-2xl justify-center min-h-[300px] min-w-[300px]">
						<div className="grid grid-cols-1 p-5 m-5 bg-gray-300 border border-gray-200 rounded-lg shadow-xl dark:border-gray-700 text-sm md:text-xl dark:bg-gray-800 min-h-max w-[300px] md:w-[600px]">
							{currentQuote && (
								<div key={currentQuote.quote}>
									...
									<h6 className="mt-4 text-center font-lobster">{currentQuote.jpn}</h6>
									<span className="my-4 text-lg text-gray-700 font-serif inline-block">
										{currentQuote.author} <br />
									</span>
									<span className="ms-3 my-4 text-lg float-right font-medium text-black">
										{" "}
										{currentQuote.anime}
									</span>
								</div>
						...
						<button
							...
							className="py-2.5 float-right px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
						>
							Next Quote
						</button>
					</div>
